    ...
    <body class="main-body">
      <header>
        <div class="box-area">
              ...
              <img src="images/logo (2).png" alt="" class="lg"></a>
            ...
            <div class="foot">
                <footer>
                    <div class="foot-main">
                        <div class="foot1">
                            <h3 font> About us</h3>
                            <p> Shivdatta Nagnath Kokane</p>
                            <a href="https://shivdattakokane.github.io/MyPortfolio/" target="_blank">read more</a>
                        </div>
                        <div class="foot2">
                            <h3>find us</h3>
                            <p>Shri Datta Maha E-seva kendra </P>
                            <p>Opposite of Alihilyadevi gas Agency</p>
                            <p>Ashti -414203</p>
                            <p>Mob:- 8766558465</p>
                        </div>
                        <div class="foot3">
                            <h3>Contact us</h3>
                            <p>For any Query cantact with us</p>
                            <br>
                        ...
                        <div class="foot4">
                            <h3>follow us</h3>
                            <ul>
                              <li><a href="https://www.instagram.com/shiv_and_datta/?hl=en" target="_blank"><i class="fab fa-instagram-square"></i></a></li>
                              <li><a href="https://www.facebook.com/shivdatta.kokanesk/?paipv=0&eav=AfZJqIq8s56VQC819UO5G3uQIgipQVBy21l-%20%20%20%20%20%20%20%20%20%20pWUWm8sF2iNpPKrAV7hU8ppHcRfp26E&_rdr" target="_blank"><i class="fab fa-facebook-square"></i></i></a></li>
                              <li><a href="https://twitter.com/Shivdattakokane" target="_blank"><i class="fab fa-twitter-square"></i></i></a></li>
                              <li><a href="https://www.linkedin.com/in/shivdatta-kokane-14948021b/" target="_blank"><i class="fab fa-linkedin"></i></a></li>
                            </ul>
                        </div>
                    <//div>
            </div>
